...
- README: Notification Forwarder
- Webhook HTTP Client
- Database Setup
- Navigation Tabs
- Gradle Wrapper Utilities
- Notification Forwarder Home Screen
- Notification Forwarder Webhook Screen
- Notification Forwarder Queue Screen
- Filter and Retry Screen
- LICENSE document
...
- `MainScreen()` --calls--> `QueueItem`  [EXTRACTED]
  app/src/main/java/com/itsazni/notificationforwarder/MainActivity.kt → app/src/main/java/com/itsazni/notificationforwarder/data/QueueItem.kt
...
### Community 1 - "NotificationRepository"
Cohesion: 0.09
...
### Community 6 - "README: Notification Forwarder"
Cohesion: 0.06
...
### Community 14 - "Notification Forwarder Home Screen"
Cohesion: 0.12
...
### Community 15 - "Notification Forwarder Webhook Screen"
Cohesion: 0.18
...
### Community 16 - "Notification Forwarder Queue Screen"
Cohesion: 0.22
...
### Community 17 - "Filter and Retry Screen"
Cohesion: 0.25
...
- **Why does `NotificationRepository` connect `NotificationRepository` to `MainActivity.kt`, `Queue Persistence`, `Notification Listener`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `README: Notification Forwarder` connect `README: Notification Forwarder` to `LICENSE document`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `QueueItem` connect `Queue Persistence` to `MainActivity.kt`, `Webhook HTTP Client`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
